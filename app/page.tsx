    ...
    <div className="flex flex-col bg-slate-300 min-h-screen">
      <div className="flex flex-col md:flex-row px-24 flex-grow">
        <div className="w-full md:w-3/4 text-left md:px-2">
          <h2 className="text-4xl md:text-9xl leading-tight mt-60 mb-10">Justice</h2>
          <h3 className="text-xl md:text-3xl font-thin leading-tight mb-12">Semantic search for depositions.</h3>
        </div>
